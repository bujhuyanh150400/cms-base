...
<body class="fixed w-screen h-screen flex justify-between items-center p-5">
    <div class="h-auto flex flex-col justify-center gap-5 p-5 bg-white z-10 lg:w-1/2 lg:basis-1/2 w-full rounded-3xl shadow-2xl lg:shadow-none lg:rounded-none">
        ...
        <form action="POST" class="">
            ...
            <div class="flex flex-col gap-5 justify-items-start items-start">
                <div class="block w-full">
                    <x-input.form-input id="email_login" type="email" label="Email" name="user_email"
                                        icon='<i class="bi bi-envelope"></i>' required="true"/>
                </div>
                <div class="block w-full">
                    <x-input.form-input id="password_login" type="password" label="Password"
                                        name="user_email" icon='<i class="bi bi-key"></i>' required="true"/>
                </div>
            </div>
